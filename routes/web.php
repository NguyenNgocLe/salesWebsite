    ...
    Route::prefix('quan-tri-vien')->group(function () {
        Route::name('quan-tri-vien.')->group(function () {
            ...
            Route::get('/quen-mat-khau',function(){
                return view('quen-mat-khau.quen-mat-khau');
            })->name('quen_mkhau');

            Route::post('/quen-mat-khau','QuanTriVienController@sendMail')->name('send-mail');
    ...
    Route::prefix('quan-tri')->group(function () {
        ...
        Route::prefix('thong-ke')->group(function () {
            Route::name('thong-ke.')->group(function () {
                Route::get('/','ThongKeController@thongke')->name('thong-ke');
            });
        });
